...
define("view/shoppingcart/shoppingCartView", function(require) {
    ...
    var ShoppingCartView = Backbone.Epoxy.View.extend({
        ...
        model:SkyModel.execute("getModel","shoppingCartModel"),
        bindings:{
        ...
        initialize:function(){
            ...
            this.listenTo(SkyModel.execute("getCollection","shoppingCartItemCollection"),"change remove",this.listenShoppingCart);
        },
        events:{
        ...
        getJsonData:function(){
            var collections = SkyModel.execute("getCollection","shoppingCartItemCollection").toJSON();
            var array = [];
